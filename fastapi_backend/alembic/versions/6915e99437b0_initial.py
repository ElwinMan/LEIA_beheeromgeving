...
Revision ID: 6915e99437b0
Revises: 
Create Date: 2025-07-16 13:25:20.722503
...
def upgrade() -> None:
    ...
    op.create_table('bookmarksSnippets',
    ...
    op.create_table('projectsSnippets',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table('storiesSnippets',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('description', sa.String(length=255), nullable=True),
    sa.Column('content', sa.JSON(), nullable=True),
    ...
    op.create_table('terrainProvidersSnippets',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_table('tool')
    op.drop_table('terrainProvidersSnippets')
    op.drop_table('storiesSnippets')
    op.drop_table('projectsSnippets')
    ...
    op.drop_table('bookmarksSnippets')
    # ### end Alembic commands ###
